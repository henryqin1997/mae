...
import models_mae_infobatch as models_mae
...
def main(args):
    ...
    dataset_train = InfoBatch(dataset_train, num_epoch = args.epochs-args.start_epoch, momentum = args.info_momentum,
                    delta = 1-0.125*args.epochs/(args.epochs-args.start_epoch))
